                ...
                <div class="add-source-page" style="display:flex;">
                    ...
                    <div class="form-left" style="width: 400px; margin: 30px;">
                        <div style="display: flex; align-items: center;">
                            <label style="width: 100px; text-align: left;">渠道名称</label>
                            <el-input v-model="channel_name" placeholder="请输入内容"></el-input>
                        </div>
                        <div style="margin-top: 20px; display: flex; align-items: center;">
                            <label style="width: 78px; text-align: left;">商品</label>
                            <el-select
                                v-model="book_index"
                                style="width:200px"
                                placeholder="请选择"
                        ...
                        <div style="margin-top: 20px; display: flex; align-items: center;">
                            <label style="width: 78px; text-align: left;">皮肤</label>
                            <el-select
                                v-model="skin_index"
                                style="width:200px"
                                placeholder="请选择"
                        ...
                        <el-button type="primary" style="margin-top:30px" @click="sendSkin">提交</el-button>
                    </div>
                    <!-- 显示部分 -->
                    <div class="show-skin">
                        <p
                            style="font-size: 16px; font-weight: 600;margin-bottom:1rem;"
                        >{{current_skin.skin_title}}</p>
                        <p>{{current_skin.skin_reason}}</p>
                        <div
                            class="scroll-wrap"
                            style="overflow: auto; height: 500px; position: relative;"
                        >
                            <img :src="current_skin.skin_img" alt style="width: 100%;">
                        </div>
                    </div>
                </div>
            </div>
