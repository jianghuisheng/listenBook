<template>
    <div id="login">
        ...
        <div class="login-box">
            ...
            <div>
                ...
                <div class="button-box" @click="goLogin">
                    <el-button :type="is_login?'primary':''" size="medium" :disabled="!is_login" >登录</el-button>
                </div>
            </div>
            ...
            <el-button type="primary" size="medium" @click="scanLogin">服务号扫码登录</el-button> 
        ...
        <div class="login-tip">
           ...
           <p style="margin-top: 0px;">为方便各渠道方登录听书宝后台，高效处理工作，现增加新功能：支持服务号绑定手机和密码，并使用手机密码登录，方便多人登录后台。（解决每次服务号登录都需管理员扫码问题）</p>
           <p style="margin-bottom: 4px;">操作方式：</p>
           <p style="margin: 0px;">1. 服务号管理员点击进入听书宝后台，选择【服务号扫码登陆】</p>
           <p style="margin-top: 0px;">2. 进入之后设置信息【手机号+密码】</p>
           <p style="margin-bottom: 4px;">注意：</p>
           <p style="margin: 0px;">1. 第一次登录需要服务号管理员进行操作</p>
           <p style="margin-top: 0px; margin-bottom: 30px;">2. 之后即可以通过手机号+密码的方式，多人登录，高效协作！</p>
        </div>
    </div>
</template>
<script>
...
<style lang="css" scoped>
    ...
    .contact-server{
        ...
        right: -40%;
        border-radius: 50%;
        box-shadow: rgba(24, 144, 255, 0.2) 1px 1px 1px 1px, rgba(24, 144, 255, 0.2) -1px -1px 1px 1px, rgba(24, 144, 255, 0.2) -1px 1px 1px 1px, rgba(24, 144, 255, 0.2) 1px -1px 1px 1px;
    }
